...
module.exports = async function (callback) {
    ...
    try {    /// Didn't catch the error that the accout doesnt have sufficient ether
        // Fetch accounnts from wallet - these are unlocked
        ...
        result = await exchange.makeOrder(token.address, tokens(200), ETHER_ADDRESS, ether(0.002), { from: user1 })
        console.log(`Made order from ${user1}`)
